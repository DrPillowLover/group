...
if(isset($_GET['search']) && !empty($_GET['search'])){
    header('Location: search/index.php?search='.trim($_GET['search']));
}
?>
<body class="rtl blog">
<div class="main_wrap">
            ...
            <div class="menu_wrapper menu_sticky">
                <div class="container p_relative h86">
                    ...
                    <form class="search_wrap mt-lg-0" id="ajax-form-search" method="get" action="#">
                        ...
                        <input type="text" id="search-form-text" class="search-field" value="" name="search" placeholder="کلید واژه مورد نظر ...">
