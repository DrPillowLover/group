    ...
    <div class="row mt-3">
        <div class="col-12 text-center mx-auto">
            <ul class="pagination  justify-content-center">
                ...
                <li class="page-item"><a class="page-link" href="categories.php?category=<?=$cat_ID?>">«</a></li>
                ...
                <?php for ($i = 1; $i <= $numberOfTotalPages; $i++) : ?>
                    ...
                    <?php if ($i > $page + 2 || $i < $page - 2) { ?>
                        <li class="page-item">
                            <a class="page-link d-none"></a>
                        </li>
                    <?php } else { ?>

                        <li class="page-item">
                            <a class="page-link"
                               href="categories.php?category=<?= $cat_ID ?>&page=<?= $i ?>"><?= $i ?></a>
                        </li>

                    <?php } ?>
                <?php endfor; ?>
                <li class="page-item"><a class="page-link"
                                         href="categories.php?category=<?= $cat_ID ?>&page=<?= $numberOfTotalPages ?>">»</a>
                </li>
            </ul>
        </div>
    </div>
